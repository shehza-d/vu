# 🎓 BSCS Academic Progress Tracker

## 📘 Semester 1

| Subject Code | Name                           | Status           | Grade | %     |
| ------------ | ------------------------------ | ---------------- | ----- | ----- |
| CS101        | Introduction to Computing      | ✅ Passed        | A     | 85.00 |
...
| Subject Code | Name                           | Status           | Grade | %   |
| ------------ | ------------------------------ | ---------------- | ----- | --- |
| CS411        | Visual Programming             | ⏳ Not Attempted | —     | —   |
| CS501        | Advanced Computer Architecture | ⏳ Not Attempted | —     | —   |
| CS602        | Computer Graphics              | ⏳ Not Attempted | —     | —   |
| CS607        | Artificial Intelligence        | ⏳ Not Attempted | —     | —   |
...
| Subject Code | Name                             | Status              | Grade | %   |
| ------------ | -------------------------------- | ------------------- | ----- | --- |
| CS619        | Final Year Project (Part I)      | ⏳ Not Eligible Yet | —     | —   |
| CS515        | Advanced Database Systems        | ⏳ Not Attempted    | —     | —   |
| CS609        | System Programming               | ⏳ Not Attempted    | —     | —   |
| CS621        | Parallel & Distributed Computing | ⏳ Not Attempted    | —     | —   |
...
| Subject Code | Name                         | Status           | Grade | %   |
| ------------ | ---------------------------- | ---------------- | ----- | --- |
| CS619        | Final Year Project (Part II) | ⏳ Pending       | —     | —   |
| CS205        | Information Security         | ⏳ Not Attempted | —     | —   |
| CS606        | Compiler Construction        | ⏳ Not Attempted | —     | —   |
